<%@ Page Language="VB" AutoEventWireup="false" CodeFile="prezzi.aspx.vb" Inherits="crociere_prezzi" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="vedisotto.js?id=1"></script>
                                    ...
                                    <asp:Image style="margin:8px; cursor:pointer; border:1px solid #dcdcdc;"  ID="ImageDetail" ImageUrl="../images/piu.gif" CssClass="Co00"   runat="server" />
                                       ...
                                       <div id="divdescri" style="visibility:hidden; height:auto; position:absolute; margin:33px 0 0 5px; " runat="server" >     
                                           <div style="float:left; border-top:1px solid #dcdcdc; ">
                                               <ul>
                                                <asp:Repeater ID="RepeaterprezziCat" runat="server">                                                 
                                                    <ItemTemplate>                                            
                                                        <li  id="rigaprezzi" runat="server" style="width:290px;">
                                            ...
                                            <div style="position:absolute; margin:0 0 0 274px; border-top:1px solid #dcdcdc;">
                                                <ul>
                                                <asp:Repeater ID="Repeaterprezzi" runat="server">                                                 
                                                    <ItemTemplate>                                            
                                                        <li  id="rigaprezzi" runat="server" style="width:120px;">
                                                            ...
                                                            <asp:Label ID="LabelTipo" Visible="false" CssClass="Co1" runat="server" Text='<%#databinder.eval(container.dataitem,"descrizione")%>'></asp:Label>
                                                        ...
                                                        <li style="width:120px; height:45px; padding-top:4px;" id="rigarq1" runat="server" visible="false">                                                             
                                                             <asp:HyperLink ID="HyperRQ"  CssClass="Co000" ForeColor="#CE006B" runat="server">Richiedi</asp:HyperLink>
                                                        </li>
                                                 </ul>
                                            </div>
